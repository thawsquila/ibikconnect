...
@section('title', 'Hubungi Kami - CDC IBI')
...
<div class="space-y-12 py-8">
    ...
    <div class="text-center space-y-4">
        ...
        <p class="text-lg text-gray-600 max-w-2xl mx-auto">Punya pertanyaan? Tim CDC & Humas IBI siap membantu Anda</p>
    </div>
    ...
    <div class="grid lg:grid-cols-3 gap-8">
        ...
        <!-- Location -->
        <div class="lg:col-span-3 bg-white rounded-xl border border-gray-200 p-8">
            <div class="flex items-center gap-3 mb-6">
                ...
                <div>
                    ...
                    <p class="text-gray-600">Institut Bisnis dan Informatika Kesatuan</p>
                </div>
            </div>
