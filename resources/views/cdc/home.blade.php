...
<div class="space-y-20">
    ...
    <section class="relative py-20 lg:py-32 overflow-hidden">
        ...
        <div class="absolute inset-0 -z-10">
            <div class="absolute inset-0 bg-linear-to-b from-blue-50 to-white"></div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center space-y-8 max-w-4xl mx-auto">
                <!-- Badge -->
                <div class="inline-flex items-center gap-2 px-4 py-2 bg-blue-100 text-blue-700 rounded-full text-sm font-medium">
                ...
                <h1 class="text-5xl md:text-6xl lg:text-7xl font-bold text-gray-900 leading-tight">
                    ...
                    untuk <span class="text-blue-600">Masa Depanmu</span>
                </h1>
                ...
                <div class="flex flex-col sm:flex-row gap-4 justify-center pt-4">
                    <a href="#lowongan" class="group inline-flex items-center justify-center px-8 py-4 bg-blue-600 text-white font-semibold rounded-xl hover:bg-blue-700 transition-all shadow-lg hover:shadow-xl hover:-translate-y-1">
    ...
    <section id="lowongan" class="scroll-mt-20">
        <div class="flex items-center justify-between mb-8">
            ...
            <a href="#" class="hidden sm:inline-flex items-center text-sm font-medium text-blue-600 hover:text-blue-700">
                Lihat Semua
        ...
        <div class="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            ...
            <article class="card p-6 hover:scale-[1.02] transition-transform group">
                <div class="flex items-start justify-between mb-4">
                    ...
                    <span class="px-3 py-1 bg-blue-50 text-blue-700 text-xs font-medium rounded-full">{{ $job['type'] }}</span>
                </div>
                <h3 class="font-semibold text-lg text-gray-900 mb-2 group-hover:text-blue-600 transition-colors">{{ $job['title'] }}</h3>
                ...
                <a href="#" class="inline-flex items-center text-sm font-medium text-blue-600 hover:text-blue-700 group-hover:gap-2 transition-all">
                    Lihat Detail
            ...
            <div class="p-6 hover:bg-gray-50 transition-colors group">
                <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                    <div class="flex gap-4">
                        ...
                        <div class="flex-1">
                            <h3 class="font-semibold text-lg text-gray-900 mb-2 group-hover:text-blue-600 transition-colors">{{ $event['title'] }}</h3>
                    ...
                    <a href="#daftar" class="btn-primary whitespace-nowrap self-start sm:self-center">
                        Daftar Sekarang
                    </a>
                </div>
            </div>
        ...
        <div class="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            ...
            <article class="card overflow-hidden group hover:scale-[1.02] transition-transform">
                ...
                <div class="p-5">
                    ...
                    <h3 class="font-semibold text-gray-900 mb-2 line-clamp-2 group-hover:text-blue-600 transition-colors">{{ $news['title'] }}</h3>
    ...
    <section id="kontak" class="scroll-mt-20">
        <div class="card p-8 bg-linear-to-br from-blue-50 to-indigo-50 border-blue-200">
            <div class="max-w-3xl mx-auto text-center">
                ...
                <div class="grid gap-6 md:grid-cols-3 mb-8">
                    <div class="bg-white rounded-xl p-6 shadow-sm">
                        ...
                        <a href="mailto:cdc@ibi.ac.id" class="text-sm text-blue-600 hover:text-blue-700">cdc@ibi.ac.id</a>
                    </div>
                    ...
                    <div class="bg-white rounded-xl p-6 shadow-sm">
                        ...
                        <a href="https://instagram.com/cdc_ibi" target="_blank" class="text-sm text-blue-600 hover:text-blue-700">@cdc_ibi</a>
                    </div>
                    ...
                    <div class="bg-white rounded-xl p-6 shadow-sm">
                        ...
                        <a href="tel:+622518240774" class="text-sm text-blue-600 hover:text-blue-700">(0251) 824-0774</a>
                    </div>
                </div>
